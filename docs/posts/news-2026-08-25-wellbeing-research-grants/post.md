...
Published: 2026-08-25 · Anthropic Newsroom
...
We work to [develop safeguards](https://www.anthropic.com/news/protecting-well-being-of-users) to identify such conversations and help ensure Claude responds appropriately, and we [publish research](https://www.anthropic.com/research/claude-personal-guidance) into the types of conversations people have with Claude to better inform how we develop our safeguards, how we evaluate them, and other measures we can take to protect users’ wellbeing. But these are nuanced considerations, and the stakes are significant. The right approach will need to evolve alongside our models and their uses.
...
As part of this program, we’re [sharing guidance](https://www-cdn.anthropic.com/files/4zrzovbb/website/5ecb637cb206057cb93cf4a9e72e843fda5e9892.pdf) from our Safeguards team on what we believe makes a wellbeing evaluation rigorous enough to build on, along with the common challenges that can limit an evaluation’s usefulness.
