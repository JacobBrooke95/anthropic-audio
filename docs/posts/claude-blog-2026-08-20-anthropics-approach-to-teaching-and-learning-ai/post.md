...
Source: https://claude.com/blog/anthropics-approach-to-teaching-and-learning-ai  
...
Today, we’re sharing our approach to designing and scaling AI instruction to millions of learners worldwide via [Claude Academy.](http://academy.claude.com) 
...
- To have Claude to recommend courses or learning paths from Claude Academy based on how you work, you can install the [Claude Academy Skill.](https://github.com/anthropics/skills/tree/main/skills/claude-academy-guide)
