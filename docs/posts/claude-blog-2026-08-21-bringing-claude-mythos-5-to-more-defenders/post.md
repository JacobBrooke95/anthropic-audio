...
- Apply for the [Cyber Verification Program](https://support.claude.com/en/articles/14604842-real-time-cyber-safeguards-on-claude-opus-and-sonnet).
- [Register your interest](https://claude.com/form/mythos-cyber-partner) in building cyber products and offerings with Mythos.
- Claude Security is available in public beta for Enterprise customers. Admins can enable Claude Security in the [admin console](http://claude.ai/admin-settings/claude-code). For a full walkthrough, see our [guide to getting started](https://claude.com/resources/tutorials/getting-started-with-claude-security). 
